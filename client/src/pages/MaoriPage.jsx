                ...
                >
                    <div className="hero-content-maori">
                        <div className="blur-container-maori">
                            <p>
                                Experience the{" "}
                                <span className="font-bold">Magic</span> of{" "}
                ...
                <div className="maori-content2">
                    <div className="maori-txt">
                        <div className="maori-text">
                            <h1>
                                Explore the <br />
                                <span className="font-bold">Māori culture</span>
                            </h1>
                            <p className="text-lg text-[#232323]">
                                Māori culture is the indigenous culture of{" "}
                                <br />
                                New Zealand, with a rich history and tradition
                    ...
                    <div className="maori-container">
                        <div className="maori-column">
                            ...
                            <div className="maori-card-txt">
                                <h1>Demigod Māui</h1>
                                <p className="text-md">
                                    Māori legend says New Zealand was fished
                                    from the sea by the daring demigod Māui.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="maori-column2">
                            ...
                            <div className="maori-card-txt">
                                ...
                                <p className="text-md">
                                    ...
                                    and was an agreement between the British
                        ...
                        <div className="maori-column">
                            ...
                            <div className="maori-card-txt">
                                ...
                                <p className="text-md">
                                    The centuries old tradition of tāmoko (Māori
                                    tattoo) is an important custom that is still
                                    practised today.{" "}
                                </p>
                            </div>
                        </div>
            ...
            <div className="maori-section3">
                <div className="maori-content2">
                    <div className="boxing">
                        ...
                        ></div>
                        <div className="box2-maori">
                            <div className="maori">
                                <div className="maori-items">
                                    <h1 className="maori-title">01</h1>
                                    <h2 className="maori-txt-2">
                                        <b style={{ color: "#232323" }}>
                                            The Heart of Māori New Zealand
                                        </b>
                                        <br />
                                        Unlock the secrets of Aotearoa's
                                        indigenous heritage, from ancient roots
                            ...
                            <div className="maori">
                                <div className="maori-items">
                                    ...
                                    <h2 className="maori-txt-2">
                                        ...
                                        <br />
                                        The ancestors of Māori arrived on canoes
                                        from Pacific islands before 1300 CE.
                                        Settling first on the coast, they hunted
                                        seals and moas.
                                    </h2>
                                </div>
                            </div>
                            ...
                            <div className="maori">
                                <div className="maori-items">
                                    ...
                                    <h2 className="maori-txt-2">
                                        ...
                                        <br />
                                        In 2019 there were nearly 800,000 Māori
                                        people, with most living in cities.
                                    </h2>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="faq-list-maori">
                            {FAQData.map((faq, index) => (
                                <div className="faq-item-maori" key={index}>
                                    ...
                                    >
                                        {faq.question}
                                        <span className="faq-icon-maori">
                                            {openIndex === index ? "−" : "+"}
                                        </span>
                                    </button>
                                    <div
                                        className={`faq-answer-maori ${
                                            openIndex === index ? "active" : ""
                                        }`}
                                    >
                                        {faq.answer}
