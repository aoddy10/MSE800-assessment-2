            ...
            <div className="landing-footer-container">
                <div className="landing-footer-links">
                    <div className="landing-column-1">
                        <img className="landing-footer-logo" src={logo} alt="Kiwi Explorer Logo"/>
                        ...
                        <div className="landing-socmed-icons-container">
                            <img className="landing-footer-socmed-icons" src={facebook} alt="facebook"/>
                            <img className="landing-footer-socmed-icons" src={twitter} alt="twitter"/>
                            <img className="landing-footer-socmed-icons" src={instagram} alt="instagram"/>
                            <img className="landing-footer-socmed-icons" src={linkedin} alt="linkedin"/>
                        </div>
