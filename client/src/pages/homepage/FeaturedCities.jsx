...
const FeaturedCities = ({ cities }) => {
  ...
  const nextSlide = () => {
    if (cities && cities.length > 0 && !isAnimating) {
      ...
      setCurrentIndex((prevIndex) => {
        ...
        return nextIndex > Math.floor((cities.length - 1) / itemsPerSlide)
          ? 0
          : nextIndex;
      });
  ...
  return (
    <section id="FeaturedCities" className="py-12 w-[100%] bg-[#f9f9fb] relative">
        ...
        <div className="flex justify-between">
          <span className="mb-6">
            ...
            <p className="text-md text-[#767676]">
              Explore New Zealand's urban gems, from bustling hubs to charming
              locales.
            </p>
          </span>
