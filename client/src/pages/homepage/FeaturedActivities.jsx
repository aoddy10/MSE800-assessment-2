...
const FeaturedActivities= ({activities}) => {
  ...
  return (
    <section className="my-12">
      ...
      <h2 className="text-2xl font-bold mb-2">This is a placeholder text for the featured Activities</h2>
          ...
          <div key={`Activitie-${activitie.id}`} className="bg-white rounded-lg shadow-lg p-4">
            ...
            <div className="flex justify-between items-center mt-3">
              ...
              <div className="flex items-center gap-1 text-yellow-500 text-sm">
                <span className="font-semibold">{activitie.avg_rating}</span> 
                <span>⭐</span>
              </div>
            </div>
            <p className="text-gray-600 text-sm mt-2">{activitie.description}</p>
