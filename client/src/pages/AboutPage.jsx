...
const FAQData = [
    {
        question: "Does Kiwi Explorer offer booking services for accommodations or activities?",
    ...
    {
        question: "Does Kiwi Explorer provide information on New Zealand's cultural and environmental guidelines?",
    ...
    {
        question: "Can I download information from Kiwi Explorer for offline use?",
                ...
                <div className="about-content">
                    <div className="about-txt">
                        <div className="about-text">
                            <h1 className='font-thin'>Your Trusted<br /><span className="font-bold">Travel Partner in New Zealand</span></h1>
                            <p>Your comprehensive guide to planning the perfect New Zealand adventure. Simplifying your New Zealand trip with expert advice and curated information and your go-to resource for accurate New Zealand travel information.</p>
                        </div>
                    </div>
                        ...
                        <div className="about-column-1">
                            <div className="about-row-1">
                                <img
                                    ...
                                    className="w-12 h-12"
                                />
                                <h3 className='text-lg font-semibold text-gray-800 leading-normal'>+2,000 Total number of users</h3>
                                <p className='text-gray-600 '>Over 2,000 travelers have explored New Zealand with Kiwi Explorer.</p>
                            </div>
                            <div
                        ...
                        <div className="about-column-3">
                            ...
                            <div className="about-row-4">
                                <img
                                    ...
                                    className="w-10 h-10"
                                />
                                <h3 className='text-lg font-semibold text-gray-800 leading-normal'>+500 Listed Attractions</h3>
                                <p className='text-gray-600 '>Discover over 500 must-see attractions across New Zealand with our curated list.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="about-section3">
                <div className="about-content">
                    <div className="subscription-container">
                        <h2>Start Your</h2>
                        <h2 className="font-bold">Adventure <span>With Us</span></h2>
                        <p>From iconic landmarks to off-the-beaten-path destinations, find 500+ attractions to explore. Let Kiwi Explorer be your guide to New Zealand.</p>
